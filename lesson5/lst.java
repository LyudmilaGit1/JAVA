...
public class lst {
    ...
    public static void main(String[] args) {
        String[] emploees = new String[] {"Иван Иванов", "Светлана Петрова", "Кристина Белова", "Анна Мусина", "Анна Крутова", "Иван Юрин", 
        ...
        nameRepeat(mapName);
        System.out.println("убывание популярности: ");
        sortName(mapName);
    }
    ...
    public static void sortName(Map<String, Integer> map){
        final Map<Integer, ArrayList<String>> sortMap = new HashMap<>();
